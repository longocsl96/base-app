...
export const showLoadingBar = value => {
  return dispatch => dispatch({ type: "SHOW_LOADING_BAR", value })
}

export const hideLoadingBar = value => {
  return dispatch => dispatch({ type: "HIDE_LOADING_BAR", value })
}
